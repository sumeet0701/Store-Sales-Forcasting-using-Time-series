...
from store_sales_forcasting.entity.artifact_entity import *
from store_sales_forcasting.entity.config_entity import *
from store_sales_forcasting.constant import *
import os
import sys
...
class Configuration:
    ...
    def __init__(self,
        ...
        try:
            ...
            self.training_pipeline_config = self.get_traininig_pipeline_config()
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            validated_train_path=os.path.join(data_validation_artifact_dir,
                                              validated_path,DATA_VALIDATION_TRAIN_FILE)
            
            validated_test_path=os.path.join(data_validation_artifact_dir,
                                             validated_path,DATA_VALIDATION_TEST_FILE)
